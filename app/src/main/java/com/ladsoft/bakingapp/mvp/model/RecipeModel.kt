...
class RecipeModel(val cacheRecipesRepository: DatabaseRecipeRepository,
                  val cacheIngredientsRepository: DatabaseIngredientRepository,
                  val cacheStepsRepository: DatabaseStepRepository): RecipeMvp.Model {
